        ...
        public static string Export(IEnumerable values, char fieldSeparator = ',', bool trimWhiteSpace = true, KeyValuePair<string, string>[] replace = null)
        {
            ...
            foreach (object item in values)
            {
                ...
                if (isNull == false)
                {
                    ...
                    INullable nullValue = item as INullable;
                    isNull = nullValue != null && nullValue.IsNull;
                }
            ...
            while (idx < textLength)
            {
                ...
                if (idx < textLength)
                {
                        ...
                        while (idx < textLength)
                        {
                            ...
                            else
                            {
                                ...
                                if ((idx + 1 < textLength) && (text[idx + 1] == '"'))
                                {
                                    ...
                                    value += text.Substring(leftIdx, idx - leftIdx);
                    ...
                    else
                    {
                        ...
                        value = text.Substring(leftIdx, idx - leftIdx).Trim();
                        idx++;
                    }
                }
                else
        ...
        private static void AddQuotes(StringBuilder text, string value)
        {
            ...
            if (valueLength > 0)
            {
                ...
                while (leftIdx < valueLength)
                {
                    ...
                    {
                        // No.
                        text.Append(value.Substring(leftIdx, valueLength - leftIdx));
                        break;
                    }
                }
